...
public:
	...
	void update(string name, void* data)
	{
...
{
public:
	void build(DXcore* core, ID3DBlob* shader, vector<ConstantBuffer>& buffers, map<string, int>& textureBindPoints, ShaderStage shaderStage)
	{
