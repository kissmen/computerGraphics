...
void Window::init(int window_width, int window_height, const std::string window_name, int window_x, int window_y){
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, wname.c_str(), wname.c_str(), style,window_x = 0, window_y = 0, width, height, NULL, NULL, hinstance, this);
...
void Window:: updateMouse(int x, int y) { mousex = x; mousey = y; }
